...
<main role="main" class="container my-5 p-5 mx-auto">
	...
	<tr>
		<td scope='col' style='background-color: var(--color-purple);'><h6 class='text-white'>Matrícula</h6></td>
		<td scope='col' style='background-color: var(--color-purple);'><h6 class='text-white'>ID Função</h6></td>
		<td scope='col' style='background-color: var(--color-purple);'><h6 class='text-white'>Data Admissão</h6></td>
		<td scope='col' style='background-color: var(--color-purple);'><h6 class='text-white'>Data Demissão</h6></td>
