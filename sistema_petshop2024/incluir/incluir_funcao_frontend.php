...
<header>
    ...
    <main role="main" class="container">
        <div class="
        my-5 col-md-8 p-5 bg-white rounded shadow-sm mx-auto">

            <form method="POST" action="incluir_funcao_backend.php">

                <div class="form-group">
                    <label for="idfuncao">ID:</label>
                    <input type="text" class="form-control" id="idfuncao" name="idfuncao">
                </div>
