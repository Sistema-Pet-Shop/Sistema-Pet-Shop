...
<body>
    ...
    <main role="main" class="container">
        <div class="my-5 col-md-8 p-5 bg-white rounded shadow-sm mx-auto">
            ...
            <form method="POST" action="incluir_pet_raca_backend.php">

                <div class="form-group">
                    <label for="idpet_raca">ID Pet Raça:</label>
                    <input type="text" class="form-control" id="idpet_raca" name="idpet_raca">
                </div>
